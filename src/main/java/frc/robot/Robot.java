...
public class Robot extends IterativeRobot {
  ...
  public void teleopPeriodic() {
    l1.set(ControlMode.PercentOutput, left.getY()*.3);
    l2.set(ControlMode.PercentOutput, left.getY() *.3);
    l3.set(ControlMode.PercentOutput, left.getY()*.3);
    r1.set(ControlMode.PercentOutput, right.getY() *.3);
    r2.set(ControlMode.PercentOutput, right.getY()*.3);
    r3.set(ControlMode.PercentOutput, right.getY()*.3);
